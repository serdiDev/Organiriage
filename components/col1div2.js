    ...
    return (
        <div className="flex flex-wrap no-underline hover:no-underline">	
            <CloudinaryContext cloudName="serdidev">
                <Image publicId={imgUrl} className="h-full w-full rounded-t pb-6" />                    
            </CloudinaryContext>
...
export default function col1div2 ({imgUrl, title, info, location}) {
    const href = imgUrl.split('/')
    return (
        <div className="w-full md:w-1/2 px-6 pt-6 pb-12 flex flex-col flex-grow flex-shrink">
